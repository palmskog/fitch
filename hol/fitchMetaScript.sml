...
Proof
 ...
 FULL_SIMP_TAC list_ss [prop_of, FLOOKUP_DEF] THEN METIS_TAC []
QED
...
Proof
 RW_TAC list_ss [map_box_admitted, valid_claim_cases] >>
 FULL_SIMP_TAC list_ss [prop_of, FLOOKUP_DEF] >>
 Cases_on `prop` >> METIS_TAC [prop_of]
QED
...
Proof
 ...
 `(prop_of prop) \/ (prop_of prop')` by METIS_TAC [prop_of, FLOOKUP_DEF] >>
 METIS_TAC [prop_of, FLOOKUP_DEF]
QED
